    ...
    public function listar($tipo_oper = 'V', $j = 0, $limpia = '')
    {
	 ...
	 $tipo_oper2='"'.$tipo_oper.'"';
	                if ($estado == '2' && $tipo_oper == 'V' && $numeroref == '')
	                    $ver = "<a href='javascript:;' onclick='comprobante_ver_pdf_conmenbrete(" . $codigo.", ".$ConversorDeNumero .",2,".$tipo_oper2. ")'><img src='" . base_url() . "images/icono_imprimir.png' width='16' height='16' border='0' title='Imprimir'></a>";
	                else
	                    $ver = '';
