    ...
    <table class="fuente8" width="100%" id="tabla_resultado" name="tabla_resultado"  align="center" cellspacing="1" cellpadding="3" border="0" >
           <tr>
                ...
                <td valign="middle">
                     ...
                     <a style="display:none;" href="<?php echo base_url();?>index.php/compras/proveedor/ventana_busqueda_proveedor/" id="linkVerProveedor"><img height='16' width='16' src='<?php echo base_url(); ?>/images/ver.png' title='Buscar' border='0' /></a>
                </td>
                <td style="display:none;"><a href="javascript:;" id="imgBuscarDocumento"><img  src="<?php echo base_url();?>images/botonbuscar.jpg" class="imgBoton" /></a>
                    <a href="javascript:;" id="imgCancelarDocumento"><img src="<?php echo base_url();?>images/botoncerrar.jpg" width="70" height="22" class="imgBoton" ></a>
                </td>
            </tr>
    </table>
    </div>
