...
<form name="form1" id="form1" method="post" action="">
	...
	<table width="100%" border="0">
	  <tr>
		<td>
			<div align="center">
				<a href="#" onclick="cargar_ubigeo();"><img src="<?php echo base_url();?>images/botonaceptar.jpg" width="70" height="22" border="1" onMouseOver="style.cursor=cursor"></a>&nbsp;
				<a href="#" onClick="window.close()"><img src="<?php echo base_url();?>images/botoncancelar.jpg" width="70" height="22" border="1" onMouseOver="style.cursor=cursor"></a>
