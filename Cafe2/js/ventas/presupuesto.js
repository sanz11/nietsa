...
function ver_presupuesto_ver_pdf_conmenbrete(presupuesto,flag_img,codigotipopresu){    
    var url = base_url+"index.php/ventas/presupuesto/presupuesto_ver_pdf_conmenbrete/"+presupuesto+"/"+flag_img+"/"+codigotipopresu;
    window.open(url,'',"width=800,height=600,menubars=no,resizable=no;")
}
