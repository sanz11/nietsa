jQuery(document).ready(function () {
    ...
    $('#edit_cliente').click(function () {
		cliente = $("#cliente").val();
            $('#edit_cliente').attr('href', base_url + 'index.php/ventas/cliente/ventana_editar_cliente/'+cliente);
...
function agregar_producto_comprobante() {
    ...
    fila += '<td ><div align="center">';           
//    fila+= '<input style="width:100%;" type="text" readonly name="proddescuento100['+n+']" id="proddescuento100['+n+']" value="'+descuento+'">'; // es el descuento que copia
    fila += '</div></td>';
    ...
    fila += '<input type="text" style="display:none;" value="n" name="detaccion[' + n + ']" id="detaccion[' + n + ']">';
    fila += '<input type="text" style="display:none;" name="prodigv100[' + n + ']" id="prodigv100[' + n + ']" value="' + igv + '">';
    ...
    fila += '<input type="text" style="display:none;" name="flagBS[' + n + ']" id="flagBS[' + n + ']" value="' + flagBS + '"/>';
    fila += '<input type="text" style="display:none;" name="prodcodigo[' + n + ']" id="prodcodigo[' + n + ']" value="' + producto + '"/>';
    fila += '<input type="text" style="display:none;" name="produnidad[' + n + ']" id="produnidad[' + n + ']" value="' + unidad_medida + '"/>';
    fila += '<input type="text" style="display:none;" name="flagGenIndDet[' + n + ']" id="flagGenIndDet[' + n + ']" value="' + flagGenInd + '"/>';
    ...
    if(flagBS=='S'){
    	if(total>0){
            ...
            fila += '<input type="text" name="codigoGuiarem[' + n + ']" id="codigoGuiarem[' + n + ']" value="' +codigoGuiarem + '">';
    ...
    fila += '</div></td>';
//    fila += '<td>';
//    fila += '<input style="width:85%;" type="text" readonly="readonly" name="proddescuento100['+n+']" id="proddescuento100['+n+']" value="'+descuento+'">'; // es el descuento que copia
//    fila += '</td>';
    fila += '<td>';
...
function agregar_fila(producto, codproducto, nombre_producto, cantidad, flagBS, flagGenInd, unidad_medida, nombre_unidad, precio_conigv, precio_sinigv, precio, igv, importe, stock, costo) {
    ...
    fila += '<input type="text" value="n" name="detaccion[' + n + ']" id="detaccion[' + n + ']">';
    fila += '<input type="text" name="prodigv100[' + n + ']" id="prodigv100[' + n + ']" value="' + igv + '">';
    fila += '<input type="text" value="" name="detacodi[' + n + ']" id="detacodi[' + n + ']">';
    fila += '<input type="text" name="proddescuento100[' + n + ']" id="proddescuento100[' + n + ']" value="0">';
    if (tipo_docu != 'B' && tipo_docu != 'N')
        fila += '<input type="text" name="proddescuento[' + n + ']" class="proddescuento" id="proddescuento[' + n + ']" onblur="calcula_importe2(' + n + ');" />';
    else
    fila += '<input type="text" name="proddescuento_conigv[' + n + ']" id="proddescuento_conigv[' + n + ']" onblur="calcula_importe2_conigv(' + n + ');" />';
    fila += '<input type="text" name="flagBS[' + n + ']" id="flagBS[' + n + ']" value="' + flagBS + '"/>';
    fila += '<input type="text" name="prodcodigo[' + n + ']" id="prodcodigo[' + n + ']" value="' + producto + '"/>';
    fila += '<input type="text" name="produnidad[' + n + ']" id="produnidad[' + n + ']" value="' + unidad_medida + '"/>';
    fila += '<input type="text" name="flagGenIndDet[' + n + ']" id="flagGenIndDet[' + n + ']" value="' + flagGenInd + '"/>';
    fila += '<input type="text" name="prodstock[' + n + ']" id="prodstock[' + n + ']" value="' + stock + '"/>';
    fila += '<input type="text" name="prodcosto[' + n + ']" id="prodcosto[' + n + ']" value="' + costo + '"/>';
      ...
      for(i=0;i<n;i++){
          ...
          c = "proddescuento["+i+"]";
            ...
            if(document.getElementById(e).value!='e'){
                ...
                descontandome = (descontandototal+descontandome);
                precio_total = money_format(importe  + precio_total);
            }
        }
     
        $("#descuentotal").val(descontandome.toFixed(2));
       ...
       for(i=0;i<n;i++){
         ...
         $("#descuentotal_conigv").val(descontandome.toFixed(2));
         $("#importetotal").val(precio_total.toFixed(2));
...
function calcula_totales_conigv() {
    ...
    for (i = 0; i < n; i++) {
        ...
        e = "detaccion[" + i + "]";
        if (document.getElementById(e).value != 'e') {
            prodimport = parseFloat(document.getElementById(a).value);

            descuento = parseFloat(document.getElementById(c).value);
            precio = parseFloat(document.getElementById(d).value);

            descun = (precio * descuento)/100;
            
            descuento_total = money_format(descun + descuento_total);
            precio_total = money_format(precio + precio_total);
            
            igv100 = parseInt($("#igv").val()); 
            igv_total = money_format(precio_total * igv100 / 100);
            importe_total = money_format(prodimport + importe_total);
        }
    ...
    $("#descuentotal_conigv").val(descuento_total.toFixed(2));
