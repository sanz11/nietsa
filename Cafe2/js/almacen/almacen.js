...
jQuery(document).ready(function(){
    ...
    $("#nuevotipoalmacen").click(function(){
    	descripcion = $("#txtdescripcion").val();
    	dataString = "descripcion="+descripcion;
    	url = base_url+"index.php/almacen/almacen/agregarta";
    	$.post(url,dataString,function(data){
    		location.href = base_url+"index.php/almacen/almacen/tipoalmacen";
    	});
    });
...
function eliminar_tipoalmacen(codigo){
	if(confirm("Esta seguro desea eliminar esete alamcen?")){
		dataString = "codigo="+codigo;
		url = base_url+"index.php/almacen/almacen/eliminarta";
		$.post(url,dataString,function(data){
//			location.href = base_url+"index.php/almacen/almacen/tipoalmacen";
		});
	}
...
function editar_tipoalmacen(codigo){
	dataString = "codigo="+codigo;
	url = base_url+"index.php/almacen/almacen/tipoalmacen";
	$.post(url,dataString,function(data){
		location.href = base_url+"index.php/almacen/almacen/tipoalmacen";
	});
}
