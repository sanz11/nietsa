...
//CUANDO SE TRATA DE VENDER			
    ...
    public function buscar_comprobante_venta_2($anio ,$mes ,$fech1 ,$fech2,$depar ,$prov  ,$dist ,$tipodocumento,$Prodcod) {
        //CPC_TipoOperacion => V venta, C compra
        //CPC_TipoDocumento => F factura, B boleta
 ...
 SELECT com.*, UBIGC_CodDpto,UBIGC_CodProv,UBIGC_CodDist,UBIGC_Descripcion from cji_comprobante com
    ...
    public function autocompleteProducto($keyword){
    	try {
    		$sql = "SELECT  CPDEC_Descripcion,CPDEP_Codigo FROM cji_comprobantedetalle where CPDEC_Descripcion LIKE '%" . $keyword . "%' and CPDEC_FlagEstado = 1 ";
