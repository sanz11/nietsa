        ...
        <tr>
			...
			<td>
	            <select id="tipopresupuesto" name="tipopresupuesto"  >
	            	<option <?php if ($tipopresupuesto == '1') echo 'selected="selected"'; ?> value="1">Producto</option>
	            	<option <?php if ($tipopresupuesto == '2') echo 'selected="selected"'; ?> value="2">Servicio</option>
	            </select>
            </td>
        </tr>
        <tr>
