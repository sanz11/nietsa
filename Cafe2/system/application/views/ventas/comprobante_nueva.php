 ...
 $(function () {
            $("#buscar_producto").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "<?php echo base_url(); ?>index.php/almacen/producto/autocomplete/" + $("#flagBS").val() + "/" + $("#compania").val(), // +"/"+$("#almacen").val() ->Lo quite para el autocomplete de ese producto cuando se ingresaba a stock almacen
                        type: "POST",
                        data: {
...
// 			var sel2 = document.getElementById("nombre_cliente");
// 		  	nombreCliente = sel2.options[sel2.selectedIndex].text;
                    ...
                    <?php if ($tipo_oper == 'V') { ?>
                        ...
                        <td valign="middle">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/ventas/cliente_ventana_busqueda/" id="linkSelecCliente"></a>
								...
								<a href="<?php echo base_url(); ?>index.php/ventas/cliente/ventana_editar_cliente/" id="edit_cliente">
   	   	   						<img src="<?php echo base_url(); ?>/images/modificar.png" />
							</a>
                        </td>
  ...
  <td width="6%" style="display:none;">
    <div align="center">
     <input type="text" size="5"
         class="cajaGeneral cajaSoloLectura"
        name="prodigv[<?php echo $indice; ?>]" id="prodigv[<?php echo $indice; ?>]" readonly="readonly" value="<?php echo $prodigv; ?>"/>
         </div>
           </td>
 ...
 <input type="hidden" name="prodigv100[<?php echo $indice; ?>]"
   ...
   value="<?php echo $igv; ?>"/>
    ...
    <input type="hidden" name="almacenProducto[<?php echo $indice; ?>]"
     ...
     <input type="text"  name="proddescuento100[<?php echo $indice; ?>]"
     ...
     if ($tipo_oper == 'C') {
                                                                ?>
           <input type="text" size="5" maxlength="10" class="cajaGeneral" readonly
           name="proddescuento[<?php echo $indice; ?>]"    id="proddescuento[<?php echo $indice; ?>]" value="<?php echo $proddescuento; ?>" onblur="calcula_importe2(<?php echo $indice; ?>);"/>
   
           
  <?php } else {
?>
 <input type="text"    name="proddescuento[<?php echo $indice; ?>]"   id="proddescuento[<?php echo $indice; ?>]"   value="<?php echo $proddescuento; ?>"  onblur="calcula_importe2(<?php echo $indice; ?>);"/>
    <?php
   }
    } else {
 ?>
<input type="text"  name="proddescuento[<?php echo $indice; ?>]" id="proddescuento[<?php echo $indice; ?>]" value="<?php echo $proddescuento; ?>"  onblur="calcula_importe2(<?php echo $indice; ?>);"/>
   <?php } ?>
    <input type="text" size="5" class="cajaGeneral cajaSoloLectura"   name="prodimporte[<?php echo $indice; ?>]"    id="prodimporte[<?php echo $indice; ?>]"
...
<div id="frmBusqueda3">
  ...
  <input class="cajaTotales" name="preciototal" type="text"
     ...
     id="descuentotal" readonly="" size="12" align="right"        value="<?php echo round($descuentotal, 2); ?>"></div>
                        </td>
...
<!--   type="text" id="visa" size="12" align="right"  value="<?php //echo round($igvtotal, 2); ?>"  onKeyPress="return numbersonly(this,event,'.');"/></div> -->
<!--                         </td> -->
