...
<div class="acciones">
			  ...
			  <table class="fuente7" width="100%" cellspacing="0" cellpadding="3" border="0">
				...
				<table class="fuente8" width="100%" cellspacing="0" cellpadding="3" border="0" ID="Table1">
                                ...
                                <td width="26%">TELEFONO</td>
                                <td width="26%">CORREO</td>
                                <td width="26%">FECHA DE ULTIMO SEGUIMIENTO</td>
                                ...
                                <td><div align="center" ><?php echo $valor[17];?></div></td>
                                <td><div align="right"><?php echo $valor[10];?></div></td>
                                ...
                                <td><div align="center"><?php echo $valor[14];?></div></td>
                                 ...
                                 <td><div align="center"><?php echo $valor[19];?></div></td>

                                <td><div align="center"><?php echo $valor[15];?></div></td>
								<td><div align="center"><?php echo $valor[16];?></div></td>

								<td><div align="center"><?php echo $valor[18];?></div></td>
                                </tr>
                                <?php
                                 }
                                }
