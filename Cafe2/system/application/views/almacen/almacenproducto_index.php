        ...
        <?php echo $form_open;?>
            <table class="fuente8" width="98%" cellspacing="0" cellpadding="3" border="0">
                <tr>
                    ...
                    <td align='left'>&nbsp;</td>
<!--                     INICO DE DESCARGA EN EXCEL -->
         <!--             <td><a href="javascript:;" onclick="descargarExcel()"  ><img src="<?php echo base_url();?>images/excel.png" class="imgBoton" onMouseOver="style.cursor=cursor" ></a>
            </td> -->
<!--                     FIN DE DESCARGAR EN EXCEL -->
                </tr>
            </table>
                        ...
                        <td>
                            <div align="left">
                                ...
                                if($flagGenInd=="I" && $stock>0){
                                    ?>
                                   <a href="#" onclick="mostrarSeriesProducto(<?php echo $producto;?>,<?php echo $valor[12];?>)"><img src="<?php echo base_url();?>images/flag-green_icon.png" width="15" height="15" border="0"/></a>
                                    <?php
                               }
                                echo $valor[2];
                                ?>
