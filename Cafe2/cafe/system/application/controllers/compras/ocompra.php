...
//        }else{
        ...
        if ($tipo_oper == 'C') {
            ...
            if ($flagPdf == 1) {
                if ($compa == 1) {
//                 	$this->cezpdf->ezImage("images/cafes.jpg", 0, 0, 'none', 'left');
                } else {	
//                 	$this->cezpdf->ezImage("images/firmacafe.png", 0, 0, 'none', 'left');
                	}
            } else {
//             	$this->cezpdf->ezImage("images/firmacafe.png", 0, 0, 'none', 'left');
...
//                 $this->cezpdf = new backgroundPDF('a4', 'portrait', 'image', array('img' => 'images/cabeceras/logocafe.jpg' . '""'));
//                 $this->cezpdf->ezText(utf8_decode_seguro($datos_empresa[0]->EMPRC_RazonSocial), 11, array("left" => 15));
	//                 $this->cezpdf->ezText(utf8_decode_seguro('Cafequipos'), 11, array("left" => 15));
//                 $this->cezpdf->ezText(utf8_decode_seguro('Principal: Av. Manco Capac Nº 701-A '), 9, array("left" => 15));
//                 $this->cezpdf->ezText(utf8_decode_seguro('Urb.El Club, 1era Etapa'), 9, array("left" => 15));
//                 $this->cezpdf->ezText(utf8_decode_seguro('Wanchaq - Cusco, Peru'), 9, array("left" => 15));
...
//            $this->cezpdf->ezText('E-mail: compuventas_pc@hotmail.com,  web: www.ferremax.com.pe', 8, array("left" => 15));            
        ...
        $fechapart = mysql_to_human($fecha);
        list($dia,$mes,$anio) = split('[/.-]',$fechapart);
        ...
        $this->cezpdf->ezText('<b>Lima, ' . $dia.' de '.$mesNombre.' de '.$anio . '</b>', 12, array("leading" => 40 - $delta, 'left' => 350));
        $this->cezpdf->ezText('Orden de ' . ($tipo_oper == 'C' ? 'Compra' : 'Venta'), 17, array("leading" => 40, 'left' => 185)); // . ' Nro. ' . $numero
...
//             array('c1' => 'RUC:', 'c2' => $ruc, 'c3' => utf8_decode_seguro('MÃ³vil:'), 'c4' => $movil),
...
//             array('c1' => utf8_decode_seguro('AtenciÃ³n:'), 'c2' => utf8_decode_seguro($nombre_contacto . ($nombre_area != '' ? ' - AREA: ' . $nombre_area : '')), 'c3' => '', 'c4' => '')
        		array('c1' => utf8_decode_seguro('SeÃ±or(es)'), 'c2' => ' : ', 'c3' => utf8_decode_seguro($nombres)),
        		array('c1' => utf8_decode_seguro('DirecciÃ³n'),  'c2' => ' : ','c3' => utf8_decode_seguro($direccion)),
        		array('c1' => utf8_decode_seguro('AtenciÃ³n'),  'c2' => ' : ','c3' => utf8_decode_seguro($nombre_contacto . ($nombre_area != '' ? ' - AREA: ' . $nombre_area : ''))),
        		array('c1' => 'RUC',  'c2' => ' : ', 'c3' => $ruc),
        		
        		array('c1' => utf8_decode_seguro('TelÃ©fono'),  'c2' => ' : ' , 'c3' => $telefono),
        		array('c1' => utf8_decode_seguro('MÃ³vil'),  'c2' => ' : ', 'c3' => $movil),
        		array('c1' => 'Fax',  'c2' => ' : ', 'c3' => $fax),
        );
        $this->cezpdf->ezTable($data_cabecera, "", "", array(
            'width' => 525,
            'showLines' => 0,
            ...
            'cols' => array(
                ...
                'c2' => array('width' => 20, 'justification' => 'left'),
                'c3' => array('width' => 100, 'justification' => 'left'),
        ...
        $this->cezpdf->ezTable($db_data, $col_names, '', array(
            ...
            'cols' => array(
                'col1' => array('width' => 25, 'justification' => 'center'),
                'col2' => array('width' => 35, 'justification' => 'center'),
                'col3' => array('width' => 60, 'justification' => 'center'),
                'col4' => array('width' => 67, 'justification' => 'left'),
                'col5' => array('width' => 220),
                'col6' => array('width' => 68, 'justification' => 'right'),
                'col7' => array('width' => 70, 'justification' => 'right')
...
//        }else{
        ...
        $data_footer = array(
            ...
            array('cols0' => utf8_decode_seguro("AlmacÃ©n"), 'cols1' => ':' . utf8_decode_seguro($nombre_almacen)),
            ...
            array('cols0' => utf8_decode_seguro("Fecha lÃ­mite entrega"), 'cols1' => ':' . $fecha_entrega),
            ...
            array('cols0' => utf8_decode_seguro("Cta. Cte. DÃ³lares"), 'cols1' => ':' . $ctactedolares),
            array('cols0' => utf8_decode_seguro("ObservaciÃ³n"), 'cols1' => ':' . $observacion)
        );
        ...
        $data_bottom = array(
            array('cols0' => utf8_decode_seguro("<b>IMPORTANTE: Esta Orden de Compra no es vÃ¡lida sin El Sello y Firma del Jefe de Compras</b>"), 'cols1' => ''),

        );
//         $this->cezpdf->ezImage("images/cabeceras/1drago.jpg", 0, 0, 'none', 'left');
        ...
        $col_names = array(
        		'col1' => 'Gerente General',
        		'col2' => 'Administrador',
        		'col3' => 'Vendedor',
        		'col4' => 'Contabilidad',
        );
        
        $this->cezpdf->ezTable($db_data1, $col_names, '', array(
        		'width' => 800,
        		'showLines' => 1,
        		'shaded' => 0,
        		'showHeadings' => 1,
        		...
        		'fontSize' => 11,
        		'cols' => array(
        				'col1' => array('width' => 100, 'justification' => 'center'),
