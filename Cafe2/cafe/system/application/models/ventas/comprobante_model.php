...
//CUANDO SE TRATA DE VENDER			
    ...
    public function buscar_comprobante_venta_2($anio ,$mes ,$fech1 ,$fech2,$depar ,$prov  ,$dist) {
        //CPC_TipoOperacion => V venta, C compra
        //CPC_TipoDocumento => F factura, B boleta
        ...
        //-----------------------
         if($anio =="--" && $mes =="--" && $fech1 =="--" && $fech2 =="--" && $depar!="--" && $prov=="--" && $dist=="--"){//DEPARTAMENTO
                $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'";
            }
        if($anio =="--" && $mes =="--" && $fech1 =="--" && $fech2 =="--" && $depar!="--" && $prov!="--" && $dist=="--"){//DEPARTAMENTO Y PROVINCIA
                $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'AND ubigeo.UBIGC_CodProv ='".$prov."'";
            }
         if($anio =="--" && $mes =="--" && $fech1 =="--" && $fech2 =="--" && $depar!="--" && $prov!="--" && $dist!="--"){//DEPARTAMENTO , PROVINCIA Y DISTRITO
                $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'AND ubigeo.UBIGC_CodProv ='".$prov."'AND ubigeo.UBIGC_CodDist ='".$dist."'";
            }

        //------------------

         if($anio !="--" && $mes =="--" && $fech1 =="--" && $fech2 =="--" && $depar!="--" && $prov=="--" && $dist=="--"){//AÑO Y DEPARTAMENTO 
               $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."' AND YEAR(CPC_FechaRegistro)='" . $anio . "'";
            }

        if($anio !="--" && $mes =="--" && $fech1 =="--" && $fech2 =="--" && $depar!="--" && $prov!="--" && $dist=="--"){//AÑO , DEPARTAMENTO Y PROVINCIA
                $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."' AND ubigeo.UBIGC_CodProv ='".$prov."'AND YEAR(CPC_FechaRegistro)='" . $anio . "'";
            }
        if($anio !="--" && $mes =="--" && $fech1 =="--" && $fech2 =="--" && $depar!="--" && $prov!="--" && $dist!="--"){//AÑO , DEPARTAMENTO , PROVINCIA Y DISTRITO
                $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'AND ubigeo.UBIGC_CodProv ='".$prov."'AND ubigeo.UBIGC_CodDist ='".$dist."' AND YEAR(CPC_FechaRegistro)='" . $anio . "'";
            }
        if($anio !="--" && $mes !="--" && $fech1 =="--" && $fech2 =="--" && $depar!="--" && $prov=="--" && $dist=="--"){//AÑO ,MES Y DEPARTAMENTO 
                $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'' AND YEAR(CPC_FechaRegistro)='" . $anio . "' AND MONTH(CPC_FechaRegistro)='" . $mes ."'";
            }

        if($anio !="--" && $mes !="--" && $fech1 =="--" && $fech2 =="--" && $depar!="--" && $prov!="--" && $dist=="--"){//AÑO ,MES, DEPARTAMENTO Y PROVINCIA
               $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'AND ubigeo.UBIGC_CodProv ='".$prov."'AND YEAR(CPC_FechaRegistro)='" . $anio . "' AND MONTH(CPC_FechaRegistro)='" . $mes ."'";
            }
        if($anio !="--" && $mes !="--" && $fech1 =="--" && $fech2 =="--" && $depar!="--" && $prov!="--" && $dist!="--"){//AÑO ,MES , DEPARTAMENTO , PROVINCIA Y DISTRITO
               $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'AND ubigeo.UBIGC_CodProv ='".$prov."'AND ubigeo.UBIGC_CodDist ='".$dist."' AND YEAR(CPC_FechaRegistro)='" . $anio . "' AND MONTH(CPC_FechaRegistro)='" . $mes ."'";
            }
            //--------

        if($anio =="--" && $mes !="--" && $fech1 =="--" && $fech2 =="--" && $depar!="--" && $prov=="--" && $dist=="--"){//AÑO actual ,MES Y DEPARTAMENTO 
               $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'' AND YEAR(CPC_FechaRegistro)='" . date("Y") . "' AND MONTH(CPC_FechaRegistro)='" . $mes ."'";
            }

        if($anio =="--" && $mes !="--" && $fech1 =="--" && $fech2 =="--" && $depar!="--" && $prov!="--" && $dist=="--"){//AÑO actual ,MES, DEPARTAMENTO Y PROVINCIA
                $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'AND ubigeo.UBIGC_CodProv ='".$prov."'AND YEAR(CPC_FechaRegistro)='" . date("Y"). "' AND MONTH(CPC_FechaRegistro)='" . $mes ."'";
            }
        if($anio =="--" && $mes !="--" && $fech1 =="--" && $fech2 =="--" && $depar!="--" && $prov!="--" && $dist!="--"){//AÑO  actual,MES , DEPARTAMENTO , PROVINCIA Y DISTRITO
              
               $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'AND ubigeo.UBIGC_CodProv ='".$prov."'AND ubigeo.UBIGC_CodDist ='".$dist."' AND YEAR(CPC_FechaRegistro)='" . date("Y") . "' AND MONTH(CPC_FechaRegistro)='" . $mes ."'";
            }

            //------------

        if($anio =="--" && $mes =="--" && $fech1 !="--" && $fech2 =="--" && $depar!="--" && $prov=="--" && $dist=="--"){//FECHIN  Y DEPARTAMENTO 
                 $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'AND CPC_FechaRegistro >= '" . $fech1 . "'";
            }

        if($anio =="--" && $mes =="--" && $fech1 !="--" && $fech2 =="--" && $depar!="--" && $prov!="--" && $dist=="--"){//FECHIN, DEPARTAMENTO Y PROVINCIA
                $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'AND ubigeo.UBIGC_CodProv ='".$prov."' AND CPC_FechaRegistro >= '" . $fech1 . "'";
            }
        if($anio =="--" && $mes =="--" && $fech1  !="--" && $fech2 =="--" && $depar!="--" && $prov!="--" && $dist !="--"){//FECHIN, DEPARTAMENTO , PROVINCIA Y DISTRITO
               $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'AND ubigeo.UBIGC_CodProv ='".$prov."'AND ubigeo.UBIGC_CodDist ='".$dist."' AND CPC_FechaRegistro >= '" . $fech1 . "'";
            }

        if($anio =="--" && $mes =="--" && $fech1  !="--" && $fech2  !="--" && $depar!="--" && $prov=="--" && $dist=="--"){//FECHIN ,FECHfin  Y DEPARTAMENTO 
                 $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'AND CPC_FechaRegistro >= '" . $fech1 . "'AND CPC_FechaRegistro <= '" . $fech2 . "";
            }

        if($anio =="--" && $mes =="--" && $fech1  !="--" && $fech2  !="--" && $depar!="--" && $prov!="--" && $dist=="--"){//FECHIN ,FECHfin, DEPARTAMENTO Y PROVINCIA
                $where ="AND ubigeo.UBIGC_CodDpto ='".$depar."'AND ubigeo.UBIGC_CodProv ='".$prov."' AND CPC_FechaRegistro >= '" . $fech1 . "'AND CPC_FechaRegistro <= '" . $fech2 . "";
            }
