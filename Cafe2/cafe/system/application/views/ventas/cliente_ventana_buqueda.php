        ...
        <table class="fuente8_2" width="100%" cellspacing="0" cellpadding="3" border="0">
           <tr class="cabeceraTabla" height="25px">
            ...
            <tr height="25">
                ...
                <td align="right">
					<a href="javascript:;" id="buscarCliente"><img src="<?php echo base_url(); ?>images/botonbuscar.jpg" class="imgBoton" /></a>
...
<div id="ventana" <?php echo $hidden; ?>>
    <div id="pagina">
        <div align="center">
                     ...
                     <div id="datosEmpresa" >
                           <table class="fuente8_2" width="100%" cellspacing="0" cellpadding="3" border="0" >
                            ...
                            <tr>
                                ...
                                <td><input  type="text" class="cajaGrande" name="razon_social" id="razon_social"  value="<?php echo $razon_social; ?>" /></td>
                            </tr>
                        </table>
                    </div>
                  <div id="divDireccion" >
