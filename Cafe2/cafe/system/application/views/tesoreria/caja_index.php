                ...
                <div align="center">
                    ...
                    <div class="acciones">
    					<div id="botonBusqueda">
        					<ul id="nuevaCaja" class="lista_botones"><li id="nuevo">Nueva Caja</li></ul>
        					<ul id="limpiarCaja" class="lista_botones"><li id="limpiar">Limpiar</li></ul>
        					<ul id="buscarCaja" class="lista_botones"><li id="buscar">Buscar</li></ul>
    					</div>
