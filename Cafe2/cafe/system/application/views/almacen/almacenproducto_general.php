                            ...
                            foreach($valor[5] as $indice2=>$valor2){ ?>
                                 <td><div align="left" style="<?php if($valor2>0) echo 'font-weight:bold; color:blue'; ?>"><?php echo $valor2;?>
                                     <?php if($indice2<count($lista_establec)){ ?>
                                            ...
                                            <?php if($flagGenInd=="I" && $valor[5]>0 ){?>
                                           		<a href="#" onclick="mostrarSeriesProducto(<?php echo  $valor[1];?>,0)"><img src="<?php echo base_url();?>images/flag-green_icon.png" width="15" height="15" border="0"/></a>
