			...
			<div align="center">
                ...
                <div id="frmBusqueda" >
			 	...
			 	<div id="botonBusqueda">
					<a href="#" id="buscarFactura"><img src="<?php echo URL_IMAGE;?>botonbuscar.jpg" width="69" height="22" border="1" onMouseOver="style.cursor=cursor"></a>
					<a href="#" id="limpiarFactura"><img src="<?php echo URL_IMAGE;?>botonlimpiar.jpg" width="69" height="22" border="1" onClick="document.getElementById('form_busqueda').reset();" onMouseOver="style.cursor=cursor"></a>
					<a href="#" id="nuevaFactura"><img src="<?php echo URL_IMAGE;?>botonnuevoproveedor.jpg" width="130" height="22" border="1" onMouseOver="style.cursor=cursor"></a>
					<a href="#" id="imprimirFactura"><img src="<?php echo URL_IMAGE;?>botonimprimir.jpg" width="79" height="22" border="1" onClick="imprimir()" onMouseOver="style.cursor=cursor"></a>
				</div>
