...
function calcula_totales() {
    ...
    for (i = 0; i < n; i++) {
        ...
        e = "detaccion[" + i + "]";
        if (document.getElementById(e).value != 'e') {
        //   importe = parseFloat(document.getElementById(a).value);descomentado
         //   igv = parseFloat(document.getElementById(b).value);descomentado
            descuento = parseFloat(document.getElementById(c).value);
            precio = parseFloat(document.getElementById(d).value);
         //   importe_total = money_format(importe + importe_total);descomentado
          //  igv_total = money_format(igv + igv_total); descomentado
            descuento_total = money_format(descuento + descuento_total);
            precio_total = money_format(precio + precio_total);
        }
    }
