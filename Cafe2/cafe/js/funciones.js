...
$(document).ready(function() {
    ...
    $("#visualizarSunat").click(function(){
    	urlConsultaRuc = "http://e-consultaruc.sunat.gob.pe/cl-ti-itmrconsruc/jcrS00Alias";
    	 window.open(urlConsultaRuc,"ventana1","width=1200,height=300,scrollbars=NO") 
    });
