...
if (!window['google']['loader']) {
    ...
    //google.loader.ServiceBase = base_url+'js/google-uds.js';
    ...
    (function() {
        ...
        google[C].d=function(a,b,c){
            if(c){
                ...
                a.appendChild(e)
            }else"script"==a?n.write('<script src="'+b+'" type="text/javascript">\x3c/script>'):"css"==a&&n.write('<link href="'+b+'" type="text/css" rel="stylesheet"></link>')
        };
