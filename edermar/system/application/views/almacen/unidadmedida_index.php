        ...
        <div id="frmBusqueda" >
            <?php echo $form_open;?>
                <table class="fuente8" width="98%" cellspacing=0 cellpadding="5" border=0>
                    <tr>
                        <td align='left' width="13%">Nombre Unidad Medida</td>
                        <td align='left'><?php echo $nombre_unidadmedida;?></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td align='left' width="13%">Simbolo</td>
                        <td align='left'><?php echo $simbolo;?></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
...
<div class="acciones">
        ...
        <div id="lineaResultado">
            <table class="fuente7" width="100%" cellspacing=0 cellpadding=3 border=0>
                <tr>
                    <td width="50%" align="left">N de unidades encontrados:&nbsp;<?php echo $registros;?> </td>
                </tr>
            </table>
        </div>
</div>
