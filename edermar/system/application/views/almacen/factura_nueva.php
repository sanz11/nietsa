...
<html>
    ...
    <div id="zonaContenido" align="center">
		...
		<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
		  <tr>
			...
			<td width="49%">
                    ...
                    <a href="#">
                         <img height="16" width="16" src="<?php echo URL_IMAGE;?>ver.png" border="0" title="Buscar proveedor">
			...
			<td width="15%">
                 <div align="right"><a href="#" onClick="agregar_producto_ocompra();"><img src="<?php echo URL_IMAGE;?>botonagregar.jpg" border="1" align="absbottom"></a></div>
            </td>
		  </tr>
		</table>
		</div>
		...
		<div id="botonBusqueda2">
			<a href="#" id="grabarFactura"><img src="<?php echo URL_IMAGE;?>botonaceptar.jpg" width="85" height="22" border="1" ></a>
			<a href="#" id="limpiarFactura"><img src="<?php echo URL_IMAGE;?>botonlimpiar.jpg" width="69" height="22" border="1" ></a>
			<a href="#" id="cancelarFactura"><img src="<?php echo URL_IMAGE;?>botoncancelar.jpg" width="85" height="22" border="1" ></a>
			<?php echo $oculto?>
		</div>		
	</div>
    </form>
