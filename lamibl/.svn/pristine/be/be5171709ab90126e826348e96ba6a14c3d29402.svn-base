...
// stylo para ocultar botones combos, etc
                            ...
                            <td width="38%" valign="middle">
                                ...
                                <?php if ($tipo_oper == 'V') { ?>
                                    ...
                                    <a href="javascript:;" id="linkVerSerieNum" <?php if ($codigo != '') echo 'style="display:none"' ?>>
                                        ...
                                        <p class="boleta" style="display:none"><?php echo $serie_suger_b . '-' . '00' . $numero_suger_b ?> 



                                        </p>

                                        <p class="factura" style="display:none"><?php echo $serie_suger_f . '-' . '00' . $numero_suger_f ?>
    ...
    <!--                                <select name="presupuesto" id="presupuesto" class="comboMedio"  onfocus="<?php echo $focus; ?>"  ><?php echo $cboPresupuesto; ?></select>-->

                                    <input type="text" class="docSerie" id="seriep" name="seriep" size="3" maxlength="3" onkeyup="return valida()"/> - 

                                    <input type="text" class="docNumero" name="presupuesto" id="presupuesto" size="3" />
    ...
    <!--<a href="<?php echo base_url(); ?>index.php/ventas/cliente/ventana_busqueda_cliente/" id="linkVerCliente"><img height='16' width='16' src='<?php echo base_url(); ?>/images/ver.png' title='Buscar' border='0' /></a>-->
                            ...
                            <td colspan="2">
                                ...
                                <a href="javascript:;" id="verDocuRefe"><img src="<?php echo base_url() ?>images/referenciardoc.png" class="imgBoton" /></a>
                        ...
                        <tr>
                            ...
                            ?>>
                                    ...
                                    <select name="vendedor" id="vendedor" class="comboMedio" style="width:210px;"><?php echo $cboVendedor; ?></select>
                                        ...
                                        <?php if ($tipo_docu != 'B' && $tipo_docu != 'N') { ?>
                                            ...
                                            <td width="6%"><div align="center"><input type="text" size="5" maxlength="10" class="cajaGeneral" name="prodpu[<?php echo $indice; ?>]" id="prodpu[<?php echo $indice; ?>]" value="<?php echo $prodpu; ?>" onblur="modifica_pu(<?php echo $indice; ?>);" onkeypress="return numbersonly(this,event,'.');" />
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <td width="12%"><div align="left"><input type="text" size="7" maxlength="10" class="cajaGeneral" name="prodcantidad[<?php echo $indice; ?>]" id="prodcantidad[<?php echo $indice; ?>]" value="<?php echo $prodcantidad; ?>" onblur="calcula_importe_conigv(<?php echo $indice; ?>);" onkeypress="return numbersonly(this,event,'.');" /><?php echo $nombre_unidad; ?>
                    ...
                    <table  width="100%" border="0" align="right" cellpadding=3 cellspacing=0 class="fuente8">
                        ...
                        <tr>
                            ...
                            if ($tipo_oper == 'V') {
                                ...
                                ?> value="<?php echo round($preciototal, 2); ?>"></div></td>

                                <?php } else { ?>

                                <td width="10%" align="right"><div align="right"><input class="cajaTotales" name="preciototal_conigv" type="text" id="preciototal_conigv" size="12" align="right" <?php
                                ...
                                if ($tipo_oper == 'V') {
                                    ...
                                    ?> value="<?php echo round($preciototal_conigv, 2); ?>"></div></td>
                        ...
                        <?php if ($tipo_oper == 'C') { ?>
                            ...
                            <tr>
                                ...
                                <td align="right" width="10%"><input type="text" onchange="descuento_porcentaje()" name="porcentaje" id="porcentaje" class="cajaTotales" value="0.00" <?php
                        ...
                        <?php if ($tipo_oper == 'V') { ?>
                            ...
                            <tr>
                                ...
                                <td align="right"><div align="right"><input class="cajaTotales" name="visa" onchange="incremento_visa()" type="text" id="visa" size="12" align="right" value="<?php echo round($igvtotal, 2); ?>" /></div></td>
                        ...
                        ?> value="<?php echo round($importetotal, 2); ?>" /></div></td>
