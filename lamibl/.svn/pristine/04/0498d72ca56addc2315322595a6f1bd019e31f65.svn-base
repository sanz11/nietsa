			...
			<div align="center">
				...
				<div id="frmBusqueda">
			 	...
			 	<div id="botonBusqueda">
                                        <ul id="imprimirCliente" class="lista_botones"><li id="imprimir">Imprimir</li></ul>
                                        <ul id="nuevoCliente" class="lista_botones"><li id="nuevo">Nuevo Cliente</li></ul>
                                        <ul id="limpiarCliente" class="lista_botones"><li id="limpiar">Limpiar</li></ul>
                                        <ul id="buscarCliente" class="lista_botones"><li id="buscar">Buscar</li></ul> 
				</div>
						...
						foreach($lista as $indice=>$valor){
							...
							<tr class="<?php echo $class;?>">
								...
								<td><div align="center"><?php echo $valor[8];?></div></td>
                                                                <td><div align="left"><?php echo $valor[9];?></div></td>
                                                                <td><div align="left"><?php echo $valor[10];?></div></td>
							</tr>
							<?php
							$i++;
							}
