...
//alert();
    urls=base_url+"index.php/reportes/ventas/ejecutarAjax/";
    enviarData="tipo_doc="+tipo_docu+"&tipo_oper="+tipo_oper+"&fecha1="+fecha1+"&fecha2="fecha2;
    alert(enviarData);
    //return false;
...
<div style="float:left;">
                ...
                <select id="tipo_doc" name="tipo_doc" onchange="ejecutarAjax2()">
                    <option value="" selected="selected" >::Seleccione::</option>
                    <option value="F" <?php if ($tipo_docu == 'F') echo ''; ?>>Factura</option>
...
<td><div align="center"><?php echo $valor_ventaS; ?></div></td>
						 ...
						 <tr>
                            ...
                            <td><div align="center">US$ <?php echo number_format($valor_totalD, 2); ?></div></td></tr>
    <?php
}
else {
    ?> </table>
