...
jQuery(document).ready(function(){
    ...
    flagBS  = $('#flagBS').val();
    $("#nuevoImpactousuario").click(function(){
      
        url = base_url+"index.php/seguridad/impactousuario/nuevo";
        location.href = url;
    });
    $("#buscarImpactousuario").click(function(){
        //alert($("#frmBusqueda").submit());
       // $("#frmBusqueda").submit();
        url = base_url+"index.php/seguridad/impactousuario/buscar";
        location.href = url;
    });	
    $("#limpiarUsuario").click(function(){
         url = base_url+"index.php/seguridad/impactousuario/listar";
        location.href = url;
    });
...
function modificar_usuario(id_usuario){
    //alert("Modificar Usuario2");
//	var base_url = $("#base_url").val();
//	url           = base_url+"index.php/seguridad/impactousuario/modificar/"+id_usuario;
//	location.href = url;
location.href = base_url+"index.php/seguridad/impactousuario/editar/"+id_usuario;
}
function ver_usuario(producto){

var base_url = $("#base_url").val();
  location.href = base_url+"index.php/seguridad/impactousuario/ver/"+producto;
}
...
function eliminar_usuario(id){
   // alert("Esta seguro que desea eliminar el usuario");
    if(confirm('¿Esta seguro desea eliminar esta usuario?')){
		dataString = "id="+id;
		url = base_url+"index.php/seguridad/impactousuario/eliminar_usuario";
		$.post(url,dataString,function(data){
			url = base_url+"index.php/seguridad/impactousuario/listar";
			location.href = url;
		});
