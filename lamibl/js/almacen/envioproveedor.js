...
jQuery(document).ready(function(){
    ...
    flagBS  = $('#flagBS').val();
    $("#nuevoEnvioproveedor").click(function(){
        url = base_url+"index.php/almacen/envioproveedor/nuevo";
        location.href = url;
    });
    $("#buscarEnvioProveedor").click(function(){
        $("#form_busquedaEnvioProveedor").submit();
    });	
    $("#limpiarEnvioProveedor").click(function(){
        url = base_url+"index.php/almacen/envioproveedor/listar";
        location.href=url;
    });
    $("#imgGuardarEnvioProveedor").click(function(){
        $("#frmEnvioProveedor").submit();
    });
    ...
    $("#imgCancelarEnvioProveedor").click(function(){
...
function editar_envioproveedor(producto){
	var base_url = $("#base_url").val();
	url           = base_url+"index.php/almacen/envioproveedor/editar_envioproveedor/"+producto;
	location.href = url;
}
function ver_envioproveedor(producto){
var base_url = $("#base_url").val();
  location.href = base_url+"index.php/almacen/envioproveedor/ver/"+producto;
}
function atras_envioproveedor(){
   url = base_url+"index.php/almacen/envioproveedor/listar";
   location.href = url;
}
...
function eliminar_envioproveedor(cod){
    if(confirm('Esta seguro desea eliminar este envio?')){
		dataString = "cod="+cod;
		url = base_url+"index.php/almacen/envioproveedor/eliminar_envioproveedor";
		$.post(url,dataString,function(data){
			url = base_url+"index.php/almacen/envioproveedor/listar";
			location.href = url;
		});
