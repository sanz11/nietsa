...
<?php echo $form_open;?>
    ...
    <div style="width:95%; align='center' float:left; margin-left: 1%; height: 400px; overflow: auto;">
        ...
        <tbody>
            <tr align="center" class="cabeceraTabla">
                <td width="40%" align="left"><input id="txtSerieSelec" type="text" class="cajaMedia" NAME="txtSerieSelec" maxlength="30" value="" readonly style="background-color:#5F5F5F"/></td>
                <td align="right">
            ...
            <tr class="itemParTabla">
                <td align="left"><input type="hidden" class="cajaMedia" value="<?php echo $series_selec[$i]->SERIC_Numero;?>" /><?php echo strtoupper($series_selec[$i]->SERIC_Numero);?></td>
                <td align="right"><a href="javascript:;" class="remove" id="<?php echo $series_selec[$i]->SERIP_Codigo; ?>" name="<?php echo $series_selec[$i]->SERIC_Numero; ?>" ></a>
