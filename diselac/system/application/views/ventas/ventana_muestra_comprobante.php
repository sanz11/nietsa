...
<head>
    ...
    <script>
        ...
        function seleccionar_comprobante(guia, serie, numero) {
            parent.seleccionar_comprobante(guia, serie, numero);
            parent.$.fancybox.close();
        }
        ...
        <ul class="lista_tipodoc">
            <li <?php if ($comprobante == 'F') {
                echo 'style="background-color: #FF0000;"';
                    ...
                    href="<?php echo base_url(); ?>index.php/ventas/comprobante/ventana_muestra_comprobante/<?php echo $tipo_oper; ?>/<?php if ($tipo_oper == 'V') echo $cliente; else echo $proveedor; ?>/SELECT_HEADER/F/<?php echo $almacen; ?>/F">Factura</a>
            </li>
            <li <?php if ($comprobante == 'B') {
                echo 'style="background-color: #FF0000;"';
            } ?> ><a
                    href="<?php echo base_url(); ?>index.php/ventas/comprobante/ventana_muestra_comprobante/<?php echo $tipo_oper; ?>/<?php if ($tipo_oper == 'V') echo $cliente; else echo $proveedor; ?>/SELECT_HEADER/F/<?php echo $almacen; ?>/B">Boleta</a>
            </li>
            <li <?php if ($comprobante == 'N') {
                echo 'style="background-color: #FF0000;"';
            } ?>  ><a
                    href="<?php echo base_url(); ?>index.php/ventas/comprobante/ventana_muestra_comprobante/<?php echo $tipo_oper; ?>/<?php if ($tipo_oper == 'V') echo $cliente; else echo $proveedor; ?>/SELECT_HEADER/F/<?php echo $almacen; ?>/N">Comprobante</a>
            </li>
            <?php if ($tipo_oper != 'C') { ?>
                <li <?php if ($comprobante == 'P') {
                    echo 'style="background-color: #FF0000;"';
                } ?> ><a
                        href="<?php echo base_url(); ?>index.php/ventas/presupuesto/ventana_muestra_presupuestoCom/<?php echo $tipo_oper; ?>/<?php if ($tipo_oper == 'V') echo $cliente; else echo $proveedor; ?>/SELECT_HEADER/<?php echo $almacen; ?>/P">PRESUPUESTO</a>
                </li>
            <?php } else { ?>
                <li <?php if ($comprobante == 'P') {
                    echo 'style="background-color: #FF0000;"';
                } ?> ><a
                        href="<?php echo base_url(); ?>index.php/compras/presupuesto/ventana_muestra_presupuestoCom/<?php echo $tipo_oper; ?>/<?php if ($tipo_oper == 'V') echo $cliente; else echo $proveedor; ?>/SELECT_HEADER/<?php echo $almacen; ?>/P">COTIZACION</a>
                </li>
            <?php } ?>
            <li <?php if ($comprobante == 'O') {
                echo 'style="background-color: #FF0000;"';
            } ?> ><a
                    href="<?php echo base_url(); ?>index.php/compras/ocompra/ventana_muestra_ocompra/<?php echo $tipo_oper; ?>/<?php if ($tipo_oper == 'V') echo $cliente; else echo $proveedor; ?>/SELECT_HEADER/F/<?php echo $almacen; ?>/O"><?php if ($tipo_oper == 'V') echo 'O. de compra(venta)'; else echo 'O. de compra'; ?></a>
            </li>
            <li <?php if ($comprobante == 'R') {
                echo 'style="background-color: #FF0000;"';
            } ?> ><a
                    href="<?php echo base_url(); ?>index.php/almacen/guiarem/ventana_muestra_recurrentes/<?php echo $tipo_oper; ?>/<?php if ($tipo_oper == 'V') echo $cliente; else echo $proveedor; ?>/SELECT_HEADER/F/<?php echo $almacen; ?>/R">Doc.
                    Recurrentes</a></li>
    ...
    <div id="frmResultado" style="width:98%; height: 150px; overflow: auto;">
        <table class="fuente8_2" width="100%" id="tblMovimientoSerie" align="center" cellspacing="1" cellpadding="3"
            ...
            if (count($lista) > 0) {
                ...
                <tr>
                    <td></td>
                    <td width="100%" style="text-align: center; font-weight: bolder" colspan="7">No hay ning&uacute;n
                        registro que cumpla con los
