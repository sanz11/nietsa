        ...
        <div id="frmBusqueda" >
            <?php echo $form_open;?>
                <table class="fuente8" width="98%" cellspacing=0 cellpadding="5" border=0>
                    <tr>
                        <td align='left' width="13%">Nombre de la categoría</td>
                        <td align='left'><?php echo $nombre_tipocliente;?></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
...
<div class="acciones">
        ...
        <div id="lineaResultado">
            <table class="fuente7" width="100%" cellspacing=0 cellpadding=3 border=0>
                <tr>
                    <td width="50%" align="left">N de categorías encontrados:&nbsp;<?php echo $registros;?> </td>
                </tr>
            </table>
</div>
        </div>
            ...
            <table class="fuente8" width="100%" cellspacing="0" cellpadding="3" border="0" ID="Table1">
                    <tr class="cabeceraTabla">
                        <td width="5%">ITEM</td>
                        <td width="50%">NOMBRE DE LA CATEGORIA</td>
                        <td width="5%">&nbsp;</td>
                        <td width="5%">&nbsp;</td>
                        <td width="5%">&nbsp;</td>
                    </tr>
