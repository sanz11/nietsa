...
class Cliente extends Controller
{
		...
		if(count($listado_clientes)>0){
			foreach($listado_clientes as $indice=>$valor){
				...
				switch($calificaciones){
					case 0: $calificacion="Excelente";
						break;
					case 1: $calificacion="Bueno";
						break;
					case 2: $calificacion="Regular";
						break;
					case 3: $calificacion="Malo";
						break;
					case 4: $calificacion="Negativo";
						break;
				}
	...
	public function insertar_cliente(){
		...
		elseif($tipo_persona==0){//Persona
			...
			if($empresa_persona!='' && $empresa_persona!='0'){
                ...
                exit('{"result":"ok", "codigo":"'.$cliente.'", "empresa": "'.$empresa.'"}');
	}
    ...
    public function autocomplete(){
        ...
        while ($data = mysql_fetch_assoc($query)) {
            ...
            $result[] = array("value" => $nombre , "codigo" => $data['CLIP_Codigo'], "ruc" => $ruc);
        }
