...
jQuery(document).ready(function(){
    ...
    $("#verificarUsuario").click(function(){
    			...
    			var txtUsuario = $("#txtUsuario").val();
	    	        ...
	    	        dataString = "comprobante=" + comprobante+"&txtUsuario="+txtUsuario+"&txtClave="+txtClave;

	    	        url = base_url + "index.php/ventas/comprobante/comprobante_eliminar_1";
	    	        $.post(url, dataString, function (data) {
    ...
    $('#nuevoRegistro').click(function(){
        ...
        fila+='<td><div align="center"><input type="radio" name="default" id="default['+n+']" value="1_'+n+'" /></div></td>'
