                    ...
                    if(key==13){
                        ...
                        if(n<=1){
                            ...
                            $.ajax({
                                ...
                                //url: 'http://localhost/zergeo/index.php/almacen/guiarem/validarstock/'+producto+'/'+cantidad,
                                type: 'get',
                                success:function(data){
                                  
                                    if(data == 0){
                                        jAlert('serie registrada anteriormente por favor ingresar otra serie','Alerta') ;
                                        return false        
                                        ...
                                        fila+='<td align="left"><input type="text" class="serie['+n+']" name="serie['+n+']" id="serie['+n+']" value="'+serie+'" class="cajaMedia" readonly="readonly" /></td>';
                        ...
                        if(n>1){
                            ...
                            if(valores==true){
                                ...
                                jAlert('serie repetida por favor ingresar otra serie','Alerta') ;
                                return false    
                               
                            }
                            else if(valores==false){
                                ...
                                $.ajax({
                                    ...
                                    success:function(data){
                                        ...
                                        if(data == 0){
                                            ...
                                            fila+='<td align="left"><input type="text" class="serie['+n+']" name="serie['+n+']" id="serie['+n+']" value="'+serie+'" class="cajaMedia" readonly="readonly" /></td>';
                                            fila+='<td align="center" width="30">';
                                            fila+='<a href="javascript:;" class="remove['+n+']" ><img src="'+base_url+'images/icono_desaprobar.png" width="16" height="16" border="0" title="Retirar de la Lista"/>';
                                            fila+='<input type="hidden" value="n" name="accion['+n+']" id="accion['+n+']" />';
                                            fila+='</td>';
                                            fila+='</tr>';
                                            $("#tabla_resultado").append(fila);
