<script type="text/javascript" src="<?php echo base_url();?>js/almacen/entregacliente.js"></script>		
<div id="pagina">
                    ...
                    if(count($lista)>0){
                        foreach($lista as $indice=>$valor)
                        {
                            ...
                            <tr class="<?php echo $class;?>">
                                ...
                                <td><div align="center"><a href="#" onclick="ver_entregacliente(<?php echo $valor[1]; ?>)"><img src="<?php echo base_url()?>images/ver.png" width="16" height="16" border="0" title="Ver"></a></div></td>
                                <td><div align="center"><a href="#" onclick="editar_entregacliente(<?php echo $valor[1]; ?>)"><img src="<?php echo base_url()?>images/modificar.png" width="16" height="16" border="0" title="Modificar"></a></div></td>
                                <td><div align="center"><a href="#" onclick="eliminar_entregacliente(<?php echo $valor[1]; ?>)"><img src="<?php echo base_url()?>images/eliminar.png" width="16" height="16" border="0" title="Eliminar"></a></div></td>
                            </tr>
                            <?php
                        }
                    }
