    ...
    <div id="pagina">
        <div id="zonaContenido">
            <div align="center" style='position: relative;width:935px;margin:0 auto;'>
                <?php if($flagBS=='B'){ ?>
                <div style='position: absolute;right:0;top: -16px'><a href="<?php echo base_url('')?>index.php/almacen/producto/productos/B" ><img src="<?php echo base_url(); ?>images/botonatras.jpg" width="85" height="22" class="imgBoton"></a></div>
                <?php }  else {?>
                   <div style='position: absolute;right:0;top: -16px'><a href="<?php echo base_url('')?>index.php/almacen/producto/productos/S" ><img src="<?php echo base_url(); ?>images/botonatras.jpg" width="85" height="22" class="imgBoton"></a></div> 
                <?php
               } ?>
                ...
                <div id="divProducto">
                    ...
                    <div align="left" class="fuente8" style="float:left;height:25px;margin-top:7px;margin-left: 15px;width: 470px;">
                        ...
                        <?php if ($flagBS == 'B') { ?>
                            ...
                            <span id="spanPrecio"><?php
                                if ($tabla_precios == '')
                                    echo '<span title="Guarde los cambios primero para ingresar los precios">&nbsp;Precios</span>';
                                else
                                    echo '<a href="javascript:;" id="prodPrecios">&nbsp;Precios</a>';
                                ?></span>
                        <?php } ?>
                    </div>
                            ...
                            <table class="fuente8" width="98%" cellspacing="0" cellpadding="6" border="0">
                                <tr>
                                    ...
                                    <td width="42%">
                                        ...
                                        <input type="text" <?php echo $readonly; ?> class="cajaMedia cajaSoloLectura" name="nombre_familia" id="nombre_familia" required="required" readonly="readonly" value="<?php echo $nombre_familia; ?>" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($especificacionPDF != '') 
                                                echo '<br /><a href="' . base_url() . 'pdf/' . $especificacionPDF . '" target="_blank"><img src="' . base_url() . 'images/pdf.png" alt="Descargar PDF" width="15" height="15" border="0" /> Descargar PDF</a>' ?>
                                        </td>
                                    </tr>
