                ...
                <form id="form_busqueda" name="form_busqueda" method="post" action="<?php echo $accion; ?>">
                    <table class="fuente8" width="98%" cellspacing="0" cellpadding="3" border="0">
                        ...
                        <tr>
                            ...
                            <td align='left'><input type="text" name="serie" id="serie" value="<?php echo $serie;?>" class="cajaGeneral"
                                                    size="3" maxlength="3" placeholder="Serie"/>
                                <input type="text" name="numero" id="numero" value="<?php echo $numero;?>" class="cajaGeneral" size="10"
            ...
            <div id="frmResultado">
                <table class="fuente8" width="100%" cellspacing="0" cellpadding="3" border="0" ID="Table1">
                    <tr class="cabeceraTabla">
                        ...
                        <td width="10%">O. C.</td>
                        <td width="5%" colspan="6">ESTADO</td>
