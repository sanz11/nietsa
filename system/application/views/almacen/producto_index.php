...
$("#buscarProducto").click(function(){
 ...
 $("#limpiarProducto").click(function(){
        url = base_url+"index.php/almacen/producto/productos/"+flagBS+"/0/1";
        location.href=url;
    });
                ...
                <form id="form_busqueda" name="form_busqueda" method="post" action="<?php echo $action; ?>">
                    <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                        <tr>
                            ...
                            <td width="34%">
 <input id="txtCodigo" type="text" class="cajaPequena" name="txtCodigo" placeholder="Codigo" maxlength="30" value="<?php echo $codigo;?>">
                        ...
                        <tr>
                            <td>Nombre</td>
                            <td>
                            <input id="txtNombre" name="txtNombre" type="text" class="cajaGrande" maxlength="100" placeholder="Nombre producto"
...
<tr>
                        ...
                        <tr>
                            <td>Familia</td>
                            <td>
                                <input id="txtFamilia" type="text" class="cajaGrande cajaSoloLectura" name="txtFamilia" placeholder="Familia producto " value="<?php echo $familia;?>" 
                                       maxlength="100" readonly="readonly" value="">
