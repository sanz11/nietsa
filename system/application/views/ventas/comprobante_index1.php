            ...
            Calendar.setup({
                ...
                button: "Calendario2"   // el id del botón que lanzará el calendario
                                ...
                                <tr>
                                    ...
                                    <td align='left'><input type="text" name="seriei" id="seriei" value="<?php echo $seriei; ?>" class="cajaGeneral" size="3" maxlength="10"  />
                                ...
                                <tr>
                                    <?php if ($tipo_oper == 'V') { ?>
                                        ...
                                        <td align='left'>
                                            ...
                                            <input type="text" name="nombre_cliente" value="<?php echo $nombre_cliente; ?>"  class="cajaGrande cajaSoloLectura" id="nombre_cliente" size="40"  />
                                ...
                                <tr>
                                    ...
                                    <td align='left'>
										...
										<input name="codproducto" type="text" class="cajaGeneral" id="codproducto" value="<?php echo $codproducto; ?>" size="10" maxlength="20" onblur="obtener_producto();" readonly="readonly" />
