            ...
            minLength: 3
                   ...
                   $("#nombre_cliente").autocomplete({
                    ...
                    select: function(event, ui){
                        ...
                        listar_contactos(ui.item.empresa);
                      //  console.log(ui.item.empresa);
                    },
                    minLength: 3
                ...
                <div id="frmBusqueda">
                    <table class="fuente8" width="100%" cellspacing="0" cellpadding="5" border="0">
                        <tr>
                            ...
                            <td width="41%" valign="middle" >
                                ...
                                switch ($tipo_codificacion) {
                                    case '1': 
                                        echo '<input type="text" name="serie" id="serie" value="' .$serie . '" class="cajaGeneral cajaSoloLectura" readonly="readonly" size="3" maxlength="10"  /> ';
                                    ...
                                    case '2': 
                                        echo '<input type="text" name="serie" id="serie" value="' . $serie. '"  class="cajaGeneral cajaSoloLectura" size="3" maxlength="10"  /> ';
                                        echo '<input type="text" name="numero" id="numero" value="' . $numero. '" class="cajaGeneral cajaSoloLectura"  size="10" maxlength="10"  /> ';
                                    break;
                                    case '3': echo '<input type="text" name="codigo_usuario" id="codigo_usuario" value="' . $codigo_usuario . '" class="cajaGeneral" size="20" maxlength="50"  />';
                                        break;
                                }
                        ...
                        <tr>
                            ...
                            <td>
                            <select id="vendedor" name="vendedor" class="comboMedio">
                            <?php echo $cboVendedor; ?>
...
<!--                                                                                                                obtener_precio_producto-->
                ...
                <div id="frmBusqueda3">
                    <table width="100%" border="0" align="right" cellpadding="3" cellspacing="0" class="fuente8">
                        <tr>
                            <td>   
                                <table  width="100%" border="0" align="right" cellpadding="4" cellspacing="0" class="fuente8">
                                    <tr>
                           ...
                           <!-- <td width="10%" valign="top">
                                <table  width="100%" border="0" align="right" cellpadding="3" cellspacing="0" style="margin-top:20px;">
                                    <tr>
                                        <td>Sub-total</td>
                                            <td width="10%" align="right"><div align="right"><input class="cajaTotales" name="preciototal" type="text" id="preciototal" size="12" align="right" readonly="readonly" value="<?php echo round($preciototal, 2); ?>" /></div></td>
                                    </tr>
