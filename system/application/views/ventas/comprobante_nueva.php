...
?>
        ...
        $(function () {
            $("#buscar_producto").autocomplete({
                ...
                select: function (event, ui) {
                    ...
                    $("#cantidad").focus();
                    $("#marcaNombreIdentif").val(ui.item.marcaNombre)
        ...
        function seleccionarOdenCompra(oCompra, serie, numero, valor)
        {
            ...
            $('#num_orden_venta').val( "00"+ serie + " - " + numero)
            console.log(oCompra);
        ...
        function seleccionar_comprobante_recu(guia, serieguia, numeroguia) {
            ...
            //<span style="font-size:15px" >Doc. Recurrente: <br/>N° de Comprobante : <br/>1 - 59245</span>
            $("#serieguiaverRecu").html('<span style="font-size:15px" >Doc. Recurrente: <br>' + serienumero + '</span>');
            $("#serieguiaverRecu").show(2000);
            $("#serieguiaver").hide(2000);
            $("#serieguiaverRecuFlecha").show(4000);
            $("#serieguiaverPre").hide(2000);
            $("#serieguiaverOC").hide(2000);
            $("#numero_ref").val('');
            $("#dRef").val('');
...
<form id="<?php echo $formulario; ?>" method="post" action="<?php echo $url_action; ?>">
                ...
                <tr>
                   <td>TDC</td>
                    <td>
                      ...
                      Vendedor
            <select name="vendedore" id="vendedore" class="comboMedio"
                              style="width:208px;">
                <?php echo $cboVendedorCod; ?></select>
                                </span>
            <input type="hidden" name="txtVendero" id="txtVendero">

                           <script type="text/javascript">
                               jQuery(document).ready(function(){
                                $('#vendedore').click(function(){
                                    $('#txtVendero').val($('#vendedore').val());
                                })
                               });
                           </script>
            ...
            <table class="fuente8" width="100%" cellspacing='0' cellpadding='3' border='0'>
                <tr>
                    ...
                    <td width="37%">
                       ...
                       <input type="hidden" name="" id="marcaNombreIdentif">
                    ...
                    <td width="16%">
                        <select <?php if ($tipo_oper != 'V') echo 'style="display:none;"'; ?> name="precioProducto"
                                   id="precioProducto"
                                       class="comboPequeno"
                    ...
                    <td width="10%">
                        <div align="right">
                            <a href="javascript:;" onClick="agregar_producto_comprobante();">
                    ...
                    if (count($detalle_comprobante) > 0) {
                        ...
                        foreach ($detalle_comprobante as $indice => $valor) {
                            ...
                            <tr id="<?php echo $indice ?>" t-doc="<?php echo $tipo_docu ?>"
                                ...
                                <td>
                                    <div align="left">
                <input type="text" class="cajaGeneral" style="width:390px;"
          ...
          value="<?php echo $prodsubtotal; ?>"
               readonly="readonly"/></div>
                      ...
                      <td width="6%" style="display:none">
                                                    <div align="center"><input type="text" size="5" maxlength="10"
                                                                               class="cajaGeneral"
                                                                               name="prodprecio_conigv[<?php echo $indice; ?>]"
                                                ...
                                                <td width="6%" style="display:none;">
                                                    <div align="center">
                                                        ...
                                                        <input type="hidden"
                                                               name="flagGenIndDet[<?php echo $indice; ?>]"
                                                        ...
                                                        <input type="hidden"
                                                               name="proddescuento100[<?php echo $indice; ?>]"
                ...
                <tr>
                    <td width="80%" rowspan="5" align="left">
                        <table width="100%" border="0" align="right" cellpadding=3 cellspacing=0 class="fuente8"
                               style="width: 736px;">
                            <tr>
                                <td width="14%" height="30"><!--Modo de impresión-->
 ...
 id="docurefe_codigo" size="14" maxlength="26"
 value="<?php echo $docurefe_codigo; ?>"/>
 <input  class="cajaGeneral" type="hidden" name="guiaremision" id="guiaremision" size="14" value="<?=$guiarem_codigo?>">
...
<tr><td>Num Orden Venta</td>
<td><input type="" name="" size="10" id="num_orden_venta" value="<?=$serie_numero_orden?>"></td>
</tr>
                            <tr>
...
<div id="ventana" style="display: none; width: 350px">
    ...
    <div id="imprimir" style="padding:20px; text-align: center">
                ...
                <div style="padding-left: 100px" >
                    ...
                    <input type="text" name="num_imp" id="num_imp" readonly="readonly"
                           style="border: 0px; font: bold 10pt helvetica;" value="lknmlk" class="cajaMedia"
                           maxlength="10">
                </div>
