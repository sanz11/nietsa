...
<html>
    ...
    <body >	
		...
		<tr>
					...
					<td><label for="usuario" style="font-size:12px;"><?php echo $emailusuario;?></label></td>
					
	  	</tr>
		<tr>			
	<input type="hidden" id="nombreusuario" name="nombreusuario" value="<?php echo $emailusuario; ?>" >
