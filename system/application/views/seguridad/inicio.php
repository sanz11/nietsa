...
$listar_morosos = $CI->producto_model->listar_morosos();
...
<?php if (isset($ver)) { ?>
    <div id="pagina" style="margin-bottom: 10px;">
    <div id="wrapper" class="clearfix" >
        ...
        <div align="center">
            ...
            <div style="width:934px;">
                <div class="content_div left margin-right" style="margin-right: 0; width: 482px;" >
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                            <tr class="cabecera_table">
                                  <td class="header" style="color:#000" colspan="5">DEBEN MAS DE 30 DIAS</td>
                            </tr>
                             <tr class="cabecera_table">
                                <td width="4%" class="css_cabectabla">ITEM</td>
                                <td width="9%" class="css_cabectabla">SERIE</td>
                                <td width="15%" class="css_cabectabla">NUMERO</td>
                                <td width="70%" class="css_cabectabla">NOMBRE/RAZON SOCIAL</td>
                            </tr>
                             <?php
                            //if(isset($listar_morosos)){
                            if ($listar_morosos != '' ) {
                                foreach ((array)$listar_morosos as $key1=>$value6) {
                                    $class = $key1%2==0?'class="itemParTabla" ':'class="itemImparTabla"';
                                       
                                        ?>
                                        <tr <?php echo $class; ?>>
                                            <td height="21" ><?php echo $t_indiceMorosos+1; ?></td>
                                            <td style="text-align: left;"><?php echo $value6->CPC_Serie; ?></td>
                                            <td style="text-align: left;"><?php echo $value6->CPC_Numero; ?></td>
                                       
                                            <td ><?php echo $value6->nombre; ?></td>
                                        </tr>
                                        <?php
                            ...
                            ?>
                            <tr>
                             <td colspan='5'><div id="pagination_container"  style="margin-top: 15px;width:100%;"><?php /*echo $paginacionMorosos;*/ ?></div></td>
                            </tr>                           
                        </tbody>
                    </table>
