            ...
            <table class="fuente8" width="100%" cellspacing="0" cellpadding="5" border="0">
                <tr>
                    ...
                    <td width="48%" valign="middle">
                        ...
                        <input name="numero" id="numero" type="text" class="cajaGeneral " size="10"
                               maxlength="10"  value="<?php echo $numero; ?>"/>
                ...
                <tr>
                    ...
                    <td width="8%">
                        %
                        Dscto
 <input name="descuento" id="descuento" type="text" class="cajaGeneral" id="descuento" size="2" maxlength="2"
            ...
            <table class="fuente8" width="100%" cellspacing='0' cellpadding='3' border='0'>
                <tr>
                    ...
                    <td width="37%">
                        ...
                        placeholder="Descripcion producto" id="nombre_producto" size="40" readonly="readonly"/>
