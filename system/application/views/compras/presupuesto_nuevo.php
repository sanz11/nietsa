...
<html>
    ...
    <script type="text/javascript" src="<?php echo base_url();?>js/compras/presupuesto.js"></script>
		  ...
		  <tr>
		    ...
		    <td width="41%" valign="middle">
                      ...
                      switch($tipo_codificacion){
                            case '1': echo '<input type="text" name="numero" id="numero" value="'.$numero.'" class="cajaGeneral cajaSoloLectura" readonly="readonly" size="10" maxlength="10"  />'; break;
