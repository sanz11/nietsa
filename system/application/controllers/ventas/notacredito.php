    ...
    public function comprobante_ver_pdf_conmenbrete_formato1($codigo, $fondo = 1){
        ...
        if ($fondo == 1) {
            if ($tp == 'V')
                ...
                $this->cezpdf = new backgroundPDF('a4', 'portrait', 'image', array('img' => 'images/img_db/nota_credito_proveedor.jpg'));
        }
            ...
            if ($fondo == 0) {
                ...
                foreach ($detalle_notacredito as $indice => $valor) {
                   ...
                   /* $this->cezpdf->addTextWrap(30 + $posiciongeneralx, $i + $posiciongeneraly, 40, 9, $cantidad, 'right');
                    ...
                    $this->cezpdf->addTextWrap(10, $i+20, 40, 9, $cantidad, 'right');
                    //unidad
                ...
                $this->cezpdf->addText(95, 690, 9, $nombre_cliente);
                $this->cezpdf->addText(130, 648, 9, $dia);
                $this->cezpdf->addText(150, 648, 9, $mes);
                $this->cezpdf->addText(200, 648, 9, $anio);
                /*$this->cezpdf->addText(95 + $posiciongeneralx, 683 + $posiciongeneraly, 9, $nombre_cliente);
              ...
              //  $this->cezpdf->addText(434 + $posiciongeneralx, 461 + $posiciongeneraly, 9, '18');
                $this->cezpdf->addText(85 + $posiciongeneralx, 663 + $posiciongeneraly, 9, substr($direccion, 0, 58));
...
//---------------------------------------------------------------------------------------------------------------		
                ...
                foreach ($detalle_notacredito as $indice => $valor) {
                    ...
                    $cod_interno = $datos_producto[0]->PROD_CodigoUsuario;
                    $producto_nom = $datos_producto[0]->PROD_Nombre;
                    $this->cezpdf->addText(100, $i-25, 8, $cod_interno);
                    $this->cezpdf->addTextWrap(10, $i-25, 40, 8, $cantidad, 'right');
                    //unidad
                    //$this->cezpdf->addText(30, $i+20, 8, utf8_decode_seguro($unidad));
...
//---------------------------------------------------------------------------------------------------------------
                if ($fondo == 1) {
                    ...
                    $this->cezpdf->addText(362, 740, 16, $serie.'-');
                    $this->cezpdf->addText(478, 740, 16, $numero);
                }
...
//PDFvernotacredit
                $this->cezpdf->addText(55, 711, 8, $nombre_cliente);
                $this->cezpdf->addText(40, 725, 8, $dia);
                $this->cezpdf->addText(90, 725, 8, $mes);
                $this->cezpdf->addText(218, 725, 8, $anio);
                $this->cezpdf->addText(50 + $posiciongeneralx, 690 + $posiciongeneraly, 8, $doc);

                //$this->cezpdf->addText(480, 554, 9, $doc);
                $this->cezpdf->addText(55, 700, 6, substr($direccion, 0, 58));
    ...
    $this->cezpdf->addTextWrap(490, 580, 55, 8,$moneda_sim."    ". number_format($importe, 4), 'right');
            ...
            if ($fondo == 0) {
                ...
                ////fecha
                $this->cezpdf->addText(116 + $posiciongeneralx, 704 + $posiciongeneraly, 10, $dia);
                $this->cezpdf->addText(166 + $posiciongeneralx, 704 + $posiciongeneraly, 10, $mes);
                $this->cezpdf->addText(292 + $posiciongeneralx, 704 + $posiciongeneraly, 10, '20' . $anio);
                ...
                ////fecha cancelado
                $this->cezpdf->addText(116 + $posiciongeneralx, 704 + $posiciongeneraly, 9, $dia);
                $this->cezpdf->addText(166 + $posiciongeneralx, 704 + $posiciongeneraly, 9, $mes);
                $this->cezpdf->addText(292 + $posiciongeneralx, 704 + $posiciongeneraly, 9, '20' . $anio);
                ///HOLA

                if ($fondo == 1) {
                    $this->cezpdf->addText(425, 742, 16, $serie);
                    $this->cezpdf->addText(470, 742, 16, $numero);
                }
                ...
                ////fecha
                $this->cezpdf->addText(500, 700, 7, $dia);
                $this->cezpdf->addText(520, 700, 7, $mes);
                $this->cezpdf->addText(540, 700, 7, '20' . $anio);
                ...
                ////fecha cancelado
//                $this->cezpdf->addText(75, 683, 7, $dia);
//                $this->cezpdf->addText(100, 700, 7, $mes);
//                $this->cezpdf->addText(155, 700, 7, '20' . $anio);
                ///
                $this->cezpdf->addText(95, 740, 9, $nombre_cliente);
                //$this->cezpdf->addText(50, 712, 9, $nombre_cliente);
                $this->cezpdf->addText(30, 692, 9, $doc);
                $this->cezpdf->addText(490, 815, 14, $doc);
                $this->cezpdf->addText(85, 668, 9, substr($direccion, 0, 58));
                $this->cezpdf->addText(390, 712, 9, $formapago_desc);

                /* $this->cezpdf->addText(60, 270, 11, "Afecta a la Factura ".$ref);		*/
