...
//echo "<br/>".$empresa;
        ...
        /* Para las imagenes */
      //<link rel="shortcut icon" href="../images/cabeva.jpg" type="image/ico" />
        //----------------------------------------------------------------------------
        //----------------------------------------------------------------------------
        $notimg = "presupuesto.jpg";
        $this->cezpdf = new Cezpdf('a4');
        $datacreator = array(
            'Title' => 'Estadillo de ',
            'Name' => 'Estadillo de ',
    ...
    //$this->cezpdf = new backgroundPDF('a4', 'portrait', 'image', array('img' => 'images/img_db/' . $notimg));
        ...
        $this->cezpdf->ezText(utf8_decode_seguro('<b>Cotización de Compra: ') . $codificacion . '</b>', 17, array("leading" => 0, 'left' => 170));
       ...
       $db_data = array(array('cols1' => utf8_decode_seguro('Señor(es)'), 'cols2' => ': ' . utf8_decode_seguro($nombre_cliente), 'cols3' => 'R.U.C.', 'cols4' => ': ' . $ruc . '       Fecha: ' . $fecha),
        ...
        $db_data = array(array('cols0' => '<b>CONDICIONES DE VENTA:</b>', 'cols1' => ''),
            ...
            array('cols0' => 'Contacto', 'cols1' => ': ' .$empresa_contacto[0]->PERSC_Nombre )
        );
        //utf8_decode_seguro($vendedor_nombre . ($vendedor_nombre_area != '' ? ' - AREA: ' . $vendedor_nombre_area : '' ))
        $this->cezpdf->ezTable($db_data, "", "", array(
            'width' => 525,
            'showLines' => 0,
            'shaded' => 0,
