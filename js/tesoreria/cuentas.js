...
// 02-09-2016   Agregando obtener_producto
function obtener_producto(){
    //alert($("#codproducto").val());
...
function mostrar_cuentas(aplica_pago) {
    ...
    $.post(url, {
        ...
        if(error == 'warning'){
            ...
            fila_total = "<tr id='trfinaltotal' ><td colspan='3'></td><td><b>Total:</b></td><td></td><td style='text-align:center;'><b>" + monto_total + "</b></td><td style='text-align:center;'><b>" + avance_total + "</b></td><td style='text-align:center;'><b>" + saldo_restante + "</b></td><td colspan='2'></td></tr>";
...
function verPdf(){
  ...
  if(tipo_cuentas==1){
   dataEviar=datafechaIni+"_"+datafechafin+"_"+series+"_"+numeros+"_"+estado_pago+"_"+comprobante+"_"+codCliente+"_"+codproducto;
   ...
   dataEviar=datafechaIni+"_"+datafechafin+"_"+series+"_"+numeros+"_"+estado_pago+"_"+comprobante+"_"+codCliente+"_"+codproducto;
    ...
    var url3 =base_url2+ "index.php/tesoreria/cuentas/verPdf/" + tipo_cuentas+"/"+dataEviar;
