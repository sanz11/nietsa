...
//            alert(seriecom);
    ...
    $("#imprimirGuiarem").click(function(){

            var fech1 = $("#fechai").val();
            var fech2 = $("#fechaf").val();
            var serie = $("#serie").val();
   ...
   if(fech1=="") {
    ...
    if(fech2=="") {
        ...
        fechaf=$("#fechaf").val().split("/");
        fech2=fechaf[2]+"-"+fechaf[1]+"-"+fechaf[0];

    }

        url = base_url+"index.php/almacen/guiarem/registro_guiarem_pdf/"+flagBS+"/"+fech1+"/"+ fech2+"/"+serie+"/"+numero+"/"+ cliente+"/"+ producto;
