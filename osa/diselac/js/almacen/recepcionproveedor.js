...
jQuery(document).ready(function(){
    ...
    $("#buscarRecepcionproveedor").click(function(){
        $("#form_busquedaRecepcionProveedor").submit();
    });	
    $("#limpiarProducto").click(function(){
        url = base_url+"index.php/almacen/garantia/listar";
        location.href=url;
    });
    $("#imgGuardarRecepcionProveedor").click(function(){
        $("#frmRecepcionProveedor").submit();
    });
     $("#limpiarRecepcionproveedor").click(function(){
...
function editar_recepcionproveedor(producto){
	var base_url = $("#base_url").val();
	url           = base_url+"index.php/almacen/recepcionproveedor/editar/"+producto;
	location.href = url;
}
...
function eliminar_recepcionproveedor(cod){
    if(confirm('Esta seguro desea eliminar esta recepcion?')){
		dataString = "cod="+cod;
		url = base_url+"index.php/almacen/recepcionproveedor/eliminar_recepcionproveedor";
		$.post(url,dataString,function(data){
			url = base_url+"index.php/almacen/recepcionproveedor/listar";
			location.href = url;
		});
