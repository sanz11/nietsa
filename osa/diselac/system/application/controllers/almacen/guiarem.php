...
//gcbq
    ...
    public function registro_guiarem_pdf($flagbs, $fech1, $fech2,$serie,$numero, $cliente, $producto)
    {
...
//        $this->cezpdf->ezText('', '', array("leading" => 100));
        $this->cezpdf->ezText('<b>LISTADO DE GUIAS DE REMISION</b>', 14, array("leading" => 0, 'left' => 185));
...
//        /* Listado de detalles */
        ...
        $listado_gr = $this->guiarem_model->listar_guiarem_pdf($flagbs ,$fech1, $fech2,$serie,$numero, $cliente, $producto);
    
            if (count($listado_gr) > 0) {
                foreach ($listado_gr as $indice => $valor) {
                    $fecha = $valor->GUIAREMC_Fecha;
                    $serie = $valor->GUIAREMC_Serie;
                    $numero = $valor->GUIAREMC_Numero;
                    $razon = $valor->nombre;
                    $subtotal = $valor->GUIAREMC_subtotal;
                    $igv = $valor->GUIAREMC_igv;
                    $total = $valor->GUIAREMC_total;
        ...
        $this->cezpdf->ezTable($db_data, $col_names, '', array(
            ...
            'cols' => array(
                ...
                'cols4' => array('width' => 40, 'justification' => 'center'),
                'cols5' => array('width' => 150, 'justification' => 'center'),
                'cols6' => array('width' => 60, 'justification' => 'left'),
                'cols7' => array('width' => 50, 'justification' => 'center'),
                'cols8' => array('width' => 105, 'justification' => 'left')
            )
        ));
