...
//                    
    ...
    public function registro_presupuesto_pdf($flagbs = 'B', $fech1, $fech2,$numero, $cliente,$producto)
    {
...
//        $this->cezpdf->ezText('', '', array("leading" => 100));
        $this->cezpdf->ezText('<b>LISTADO DE PRESUPUESTOS</b>', 14, array("leading" => 0, 'left' => 185));
        $this->cezpdf->ezText('', '', array("leading" => 10));
...
//        /* Listado de detalles */
        ...
        $listado_presupuestos = $this->presupuesto_model->listar_presupuesto_pdf($flagbs,$fech1, $fech2,$numero, $cliente,$producto);
            ...
            if (count($listado_presupuestos) > 0) {
                foreach ($listado_presupuestos as $indice => $valor) {
                    ...
                    $numero = $valor->PRESUC_Numero;
                    $codigo = $valor->PRESUP_Codigo;
                     $razon = $valor->PRESUC_NombreAuxiliar;
                    $total = $valor->MONED_Simbolo . ' ' . number_format($valor->PRESUC_total, 2);
        ...
        $this->cezpdf->ezTable($db_data, $col_names, '', array(
            ...
            'cols' => array(
                ...
                'cols6' => array('width' => 245, 'justification' => 'left'),
