...
class Configuracion extends Controller{
   ...
   /*Configuracion*/
    public function editar_configuracion(){
        ...
        $FacBol              = form_checkbox(array('name'=>'s_comprobante','id'=>'s_comprobante'),'1', ($comp_confi[0]->COMPCONFIC_StockComprobante[0]=='1' ? true : false));
        $guia                = form_checkbox(array('name'=>'s_guia','id'=>'s_guia'),'1',($comp_confi[0]->COMPCONFIC_StockGuia[0]=='1' ? true : false));
        ...
        foreach($datos_configuracion as $indice=>$valor){
            ...
            switch($id){
                case 1 :$arrayValores_serie[0] = $serie; $arrayValores[0] = $numero;break;//opedido
                case 2: $arrayValores_serie[1] = $serie; $arrayValores[1]  = $numero;break;//cotizacion
                case 3: $arrayValores_serie[2] = $serie; $arrayValores[2]  = $numero;break;//ocompra
                case 4: $arrayValores_serie[3] = $serie; $arrayValores[3]  = $numero;break;//inventario
                case 5: $arrayValores_serie[4] = $serie; $arrayValores[4]  = $numero;break;//guiain
                case 6: $arrayValores_serie[5] = $serie; $arrayValores[5]  = $numero;break;//guiasa
                case 7: $arrayValores_serie[6] = $serie; $arrayValores[6]  = $numero;break;//valesa
                case 8: $arrayValores_serie[7] = $serie; $arrayValores[7]  = $numero;break;//factura
                case 9: $arrayValores_serie[8] = $serie; $arrayValores[8]  = $numero;break;//boleta
                case 10: $arrayValores_serie[9] = $serie; $arrayValores[9]   = $numero;break;//guiaremi
                case 11: $arrayValores_serie[10] = $serie; $arrayValores[10] = $numero;break;//notacred
                case 12: $arrayValores_serie[11] = $serie; $arrayValores[11] = $numero;break;	//notadeb
                case 13: $arrayValores_serie[12] = $serie; $arrayValores[12] = $numero;break;	//presupuesto
                case 14: $arrayValores_serie[13] = $serie; $arrayValores[13] = $numero;break;	//comprobante general
            }
        }
        $documentos = array(
    ...
    public function cargar_configuracion_detalle(){
         ...
         if(count($datos_configuracion)>0){
             foreach($datos_configuracion as $indice=>$valor){
                 ...
                 $numero = $valor->CONFIC_Numero;
                 switch($id){
                     case 1 : $arrayValores[0]  = $numero;break;//opedido
                     case 2: $arrayValores[1]  = $numero;break;//cotizacion
                     case 3: $arrayValores[2]  = $numero;break;//ocompra
                     case 4: $arrayValores[3]  = $numero;break;//inventario
                     case 5: $arrayValores[4]  = $numero;break;//guiain
                     case 6: $arrayValores[5]  = $numero;break;//guiasa
                     case 7: $arrayValores[6]  = $numero;break;//valesa
                     case 8: $arrayValores[7]  = $numero;break;//factura
                     case 9: $arrayValores[8]  = $numero;break;//boleta
                     case 10: $arrayValores[9]   = $numero;break;//guiaremi
                     case 11: $arrayValores[10] = $numero;break;//notacred
                     case 12: $arrayValores[11] = $numero;break;	//notadeb
                 }
             }
