...
require_once 'system/application/libraries/Excel/oleread.php';
    ...
    function _parse()
    {
        ...
        // Read in the number of characters
                                        ...
                                        // Read in the crun
                                                ...
                                                //PARCHE
                                                //$retstr = ($asciiEncoding) ? mb_convert_encoding($retstr,'utf-8','cp1252'):'';
                                                $incoming_charset = defined('EXCEL_READER_INPUT_CHARSET')? EXCEL_READER_INPUT_CHARSET:'cp1252';
                                                $retstr = ($asciiEncoding) ? iconv($incoming_charset, 'utf-8', $retstr) : $this->_encodeUTF16($retstr);
