...
//VENTA NOTA_CREDITO PDF INICIA
                ...
                $this->cezpdf->addText(500, 446, 9, $moneda_sim);
                $this->cezpdf->addTextWrap(490, 446, 55, 9, $subtotal, 'right');
                $this->cezpdf->addText(500, 463, 9, $moneda_sim);
                $this->cezpdf->addTextWrap(490, 463, 55, 9, $igv, 'right');
                $this->cezpdf->addText(500, 428, 9, $moneda_sim);
                $this->cezpdf->addTextWrap(490, 428, 55, 9, number_format($importe, 2), 'right');
                //------------------------------------------------------------------------------------------------------------------------
            }
        } else {
            if ($fondo == 0) {
