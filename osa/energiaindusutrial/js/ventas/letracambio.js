...
//        }else{
//            url = base_url+"index.php/ventas/letracambio/comprobante_insertar_ref";
//        }
        //        $('#frmComprobante').submit();
        //        return false;
        //        
        /*   $('#frmComprobante').attr('action', url);
        $('#frmComprobante').submit();
        return false;
...
//                      taba asi  $('#linkVerImpresion').click();
...
//////aumentado
//function cargar_provinciapago(obj){
//    departamento = obj.value;
//    provincia    = "01";
//    if(departamento!='00'){
//        url = base_url+"index.php/maestros/ubigeo/cargar_ubigeopago/"+departamento+"/"+provincia;
//        $("#divUbigeopago").load(url);
//    }
//}
//function cargar_distritopago(obj){
//    departamento = $("#cboDepartamentopago").val();
//    provincia    = obj.value;
//    if(departamento!='00' && provincia!='00'){
//        url = base_url+"index.php/maestros/ubigeo/cargar_ubigeopago/"+departamento+"/"+provincia;
//        $("#divUbigeopago").load(url);
